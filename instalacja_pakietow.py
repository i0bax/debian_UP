...
os.system("apt-get install -y armitage backdoor-factory cisco-auditing-tool cisco-global-exploiter cisco-ocs cisco-torch crackle jboss-autopwn linux-exploit-suggester maltego-teeth set shellnoob sqlmap thc-ipv6 yersinia beef-xss > /dev/null")
print('\x1b[1;32m' + 'ZAINSTALOWANE!' + '\x1b[0m')
# Forensics Tools
print ('\x1b[1;34m' + 'INSTALACJA Forensics Tools' + '\x1b[0m')
os.system("apt-get install -y binwalk bulk-extractor chntpw cuckoo dc3dd ddrescue dumpzilla extundelete foremost galleta guymager iphone-backup-analyzer p0f pdf-parser pdfid pdgmail peepdf volatility xplico > /dev/null")
print('\x1b[1;32m' + 'ZAINSTALOWANE!' + '\x1b[0m')
# Stress Testing
print ('\x1b[1;34m' + 'INSTALACJA Stress Testing' + '\x1b[0m')
os.system("apt-get install -y dhcpig funkload iaxflood inviteflood ipv6-toolkit mdk3 reaver rtpflood slowhttptest t50 termineter thc-ipv6 thc-ssl-dos > /dev/null")
print('\x1b[1;32m' + 'ZAINSTALOWANE!' + '\x1b[0m')
# Password Attacks
print ('\x1b[1;34m' + 'INSTALACJA Password Attacks' + '\x1b[0m')
os.system("apt-get install -y acccheck burpsuite cewl chntpw cisco-auditing-tool cmospwd creddump crunch findmyhash gpp-decrypt hash-identifier hexorbase john johnny keimpx maltego-teeth maskprocessor multiforcer ncrack oclgausscrack pack patator polenum rainbowcrack rcracki-mt rsmangler statsprocessor thc-pptp-bruter truecrack webscarab wordlists zaproxy > /dev/null")
print('\x1b[1;32m' + 'ZAINSTALOWANE!' + '\x1b[0m')
# Reverse Engineering
print ('\x1b[1;34m' + 'INSTALACJA Reverse Engineering' + '\x1b[0m')
os.system("apt-get install -y apktool dex2jar python-diStorm3 edb-debugger jad javasnoop JD OllyDbg smali Valgrind YARA > /dev/null")
print('\x1b[1;32m' + 'ZAINSTALOWANE!' + '\x1b[0m')
# Hardware Hacking
print ('\x1b[1;34m' + 'INSTALACJA Hardware Hacking' + '\x1b[0m')
os.system("apt-get install -y android-sdk apktool arduino dex2jar sakis3g smali > /dev/null")
print('\x1b[1;32m' + 'ZAINSTALOWANE!' + '\x1b[0m')
# Dodatki
print ('\x1b[1;34m' + 'INSTALACJA Dodatkow' + '\x1b[0m')
os.system("apt-get install -y usbguard usbguard-applet-qt > /dev/null")
print('\x1b[1;32m' + 'ZAINSTALOWANE!' + '\x1b[0m')
